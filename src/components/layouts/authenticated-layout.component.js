                                ...
                                {!item.children ? (
                                    ...
                                    <Disclosure as="div">
                                        {({ open }) => (
                                            ...
                                            <Disclosure.Button
                                                className={classNames(
                                                item.current ? 'bg-sidebarHover text-sidebarActiveText' : 'text-sidebarInactiveText hover:text-sidebarHoverText hover:bg-sidebarHover',
                                            ...
                                            >
                                                <item.icon className={classNames(
                                                    ...
                                                    : 'text-sidebarInactiveText group-hover:text-sidebarHoverText',
                                                    'h-6 w-6 shrink-0'
                                                )} aria-hidden="true" />
                                                {item.name}
                                                <ChevronRightIcon
                                                className={classNames(
                                                    open ? 'rotate-90 text-sidebarHoverText' : 'text-sidebarInactiveText hover:text-sidebarHoverText',
                                            ...
                                            <Disclosure.Panel as="ul" className="mt-1 px-2">
                                                {item.children.map((subItem) => (
                                                    <li key={subItem.name}>
                                                        ...
                                                        href={subItem.href}
                                                        className={classNames(
                                                            subItem.current ? 'bg-sidebarHover text-sidebarActiveText' : 'text-sidebarInactiveText hover:text-sidebarHoverText hover:bg-sidebarHover',
                        ...
                        {!item.children ? (
                            <Link
                                ...
                                className={classNames(
                                    item.current
                                    ? 'bg-sidebarHover text-sidebarActiveText'
                                    : 'text-sidebarInactiveText  hover:bg-sidebarHover hover:shadow-outline hover:text-sidebarHoverText',
                                    'group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold'
                                )}
                                >
                                <item.icon
                                    className={classNames(
                                    item.current ? 'text-sidebarActiveText' : 'text-sidebarInactiveText group-hover:shadow-outline group-hover:text-sidebarHoverText',
                                    'h-6 w-6 shrink-0'
                                    )}
                                    aria-hidden="true"
                                />
                            ...
                            <Disclosure as="div">
                                {({ open }) => (
                                    ...
                                    >
                                        ...
                                        <ChevronRightIcon
                                        className={classNames(
                                            open ? 'rotate-90 text-sidebarActiveText' : 'text-sidebarInactiveText hover:text-sidebarHoverText',
                                            'ml-auto h-5 w-5 shrink-0'
                                        )}
                                        aria-hidden="true"
                                        />
                                    ...
                                    <Disclosure.Panel as="ul" className="mt-1 px-2">
                                        ...
                                        <li key={subItem.name}>
                                            ...
                                            className={classNames(
                                                subItem.current
                                                ? 'bg-sidebarHover text-sidebarActiveText font-semibold'
                                                : 'text-sidebarInactiveText hover:text-sidebarHoverText hover:bg-sidebarHover',
...
{/* 
          <img 
              ...
              src="/unplan_logo.svg"
          /> */}
            <h2 className='font-heading text-brand' >UNPLAN</h2>
