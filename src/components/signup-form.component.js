...
const SignupForm = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center bg-white p-10 rounded-lg shadow-md max-w-md text-sm">

            {/* Google Sign-in Button */}
            <button className="flex items-center justify-center gap-4 w-full px-4 py-2 border border-gray-300 rounded shadow-sm font-bold text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
