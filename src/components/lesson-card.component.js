...
const LessonCard = ({ lesson }) => {
    return (
        <Link href={`/view-lesson/${lesson.id}`} className="block bg-white rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105 cursor-pointer break-words">
